...
public class ThreeDataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("MybatisPlusThreeDataSource") DataSource dataSource) throws Exception {
        //配置myabtisSqlSession
        ...
        sessionFactoryBean.setTypeAliasesPackage("com.leilei.entity.three");
