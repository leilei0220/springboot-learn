...
public class SpringBootredisTest {
    ...
    public void testZset() {
        ...
        redisTemplate.opsForZSet().add("xxxx12312", "hhh", System.currentTimeMillis());
        redisTemplate.opsForZSet().add("xxxx12312", "iii", System.currentTimeMillis());
        redisTemplate.opsForZSet().add("xxxx12312", "jjj", System.currentTimeMillis());
        redisTemplate.opsForZSet().add("xxxx12312", "hhh", 123123123);
        Long size = redisTemplate.opsForZSet().size("xxxx12312");
        if (size != null && size > 3) {
            Long xxxx12312 = redisTemplate.opsForZSet().removeRange("xxxx12312", 0, size - 3 - 1);
            System.out.println(xxxx12312);
        }
    ...
    public void testHash() {
        redisTemplate.executePipelined(new RedisCallback<Object>() {
            ...
            RedisSerializer<Object> valueSer = (RedisSerializer<Object>) redisTemplate.getHashValueSerializer();
            @SuppressWarnings("unchecked")
            RedisSerializer<Object> keySer = (RedisSerializer<Object>) redisTemplate.getKeySerializer();
            @SuppressWarnings("unchecked")
            RedisSerializer<Object> hashKeySer = (RedisSerializer<Object>) redisTemplate.getHashKeySerializer();

            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                byte [] data = valueSer.serialize(null);
                connection.hSet("111".getBytes(), "333".getBytes(), data);
                return null;
            }
        });
    }
